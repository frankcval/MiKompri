// Plan detallado (pseudoc�digo):
// 1. Preparar mocks para IPurchaseListRepository e IUnitOfWork usando Moq.
// 2. Caso 1: Lista existe
//    - Crear un PurchaseList v�lido usando su ctor p�blico (nombre, ownerId, groupId opcional).
...
// Nota: este archivo asume las rutas/espacios de nombres t�picos; ajustar using si su soluci�n difiere.
...
using MiKompri.ShoppingList.Domain; // Ajustar si la entidad PurchaseList est� en otro namespace
using MiKompri.ShoppingList.Domain.Entities; // Ajustar seg�n su proyecto
...
namespace MiKompri.ShoppingList.Application.Tests.Commands.UpdateShoppingList
{
    public class UpdateShoppingListCommandHandlerTests
    {
        ...
        public async Task Handle_WhenListExists_RenamesAndChangesGroupAndSaves()
        {
            ...
            Assert.NotNull(existingList.UpdatedAt);
        }
